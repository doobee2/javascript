...
//처음부터 다시 재생
function restartPlay() { restartPlay(); }
//앞으로, 뒤로 가기 함수 
function skip(value) { video.currentTime = video.currentTime + value }  //video.currentTime += value
//재생일시정지 함수
function playPause () {  
...
progress.addEventListener("click", function () {
    seek(event);
>>>>>>> 24806404f3a5f944362fb075af9699867819bc49
});//seek